...
contract ElkRouter is IElkRouter {
    ...
    function addLiquidityAVAX(
        ...
        address to,
        uint deadline
    ) external payable virtual override ensure(deadline) returns (uint amountToken, uint amountAVAX, uint liquidity) {
    ...
    function _swap(uint[] memory amounts, address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            IElkPair(ElkLibrary.pairFor(factory, input, output)).swap(amount0Out, amount1Out, to, new bytes(0));
        }
    }
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, ElkLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, ElkLibrary.pairFor(factory, path[0], path[1]), amountIn);
